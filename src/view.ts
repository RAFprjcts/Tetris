export default class View {
    ...
    playfieldBorderWidth: number;
    playfieldX: number;
    playfieldY: number;
    playfieldWidth: number;
    playfieldHeight: number;
    playfieldInnerWith: number;
    playfieldInnerHeight: number;
    ...
    constructor(element, w: number, h: number, r: number, c: number) {
        ...
        this.playfieldInnerWith = this.playfieldWidth - this.playfieldBorderWidth * 2;
        this.playfieldInnerHeight = this.playfieldHeight - this.playfieldBorderWidth * 2;

        this.blockWidth = this.playfieldInnerWith / c;
        this.blockHeight = this.playfieldInnerHeight / r;
